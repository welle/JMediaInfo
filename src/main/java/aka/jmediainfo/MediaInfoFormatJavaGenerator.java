...
public final class MediaInfoFormatJavaGenerator {
    ...
    public static void main(final String[] args) {
        ...
        if (path == null || basePackage == null) {
            LOGGER.logp(Level.SEVERE, "MediaInfoFormatJavaGenerator", "main", "No path");
        } else {
    ...
    private void createConstantsFile(@NonNull final String kind, @NonNull final Map<@NonNull String, String> map, @NonNull final String path, @NonNull final String basePackage) {
        try {
            ...
            javaLines.add("package " + basePackage + ".constants.format;");
            javaLines.add("");
        ...
        final IOException e) {
            LOGGER.logp(Level.SEVERE, "MediaInfoFormatJavaGenerator", "createConstantsFile", e.getMessage(), e);
        }
    }
    ...
    private Map<@NonNull String, String> parse(@NonNull final String url) {
        ...
        try {
            ...
            LOGGER.logp(Level.SEVERE, "MediaInfoFormatJavaGenerator", "parse", e.getMessage(), e);
        }
